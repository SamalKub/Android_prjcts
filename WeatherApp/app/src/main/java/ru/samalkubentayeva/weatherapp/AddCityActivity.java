...
//        homeRL = findViewById(R.id.idRLHome2);
//        loadingPB = findViewById(R.id.idPBLoading2);
        cityNameTV = findViewById(R.id.idTVCityName2);
        temperatureTV = findViewById(R.id.idTVTemperature2);
        conditionTV = findViewById(R.id.idTVCondition2);
        weatherRV = findViewById(R.id.idRvWeather2);
        backIV = findViewById(R.id.idIVBlack2);
        iconIV = findViewById(R.id.idIVIcon2);
        weatherRVModalArrayList = new ArrayList<>();
        weatherRVAdapter = new WeatherRVAdapter(this, weatherRVModalArrayList);
        weatherRV.setAdapter(weatherRVAdapter);
        uvindexTV = findViewById(R.id.idTVUVindexMain2);

        Intent intent = getIntent();
        String textCityName = intent.getStringExtra(MainActivity.EXTRA_TEXT);

        cityNameTV.setText(textCityName);


//        cityName = getCityName(location.getLongitude(), location.getLatitude());
        getWeatherInfo(textCityName);
////
...
//                        Picasso.get().load("").into(backIV);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AddCityActivity.this, "Please enter valid city name..", Toast.LENGTH_SHORT).show();
            }
        });
        RequestQueue requestQueue = Volley.newRequestQueue(AddCityActivity.this);
